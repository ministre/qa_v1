...
urlpatterns = [
    ...
    path('test/value/create/<int:test_pattern_id>/<int:type_id>/', views.test_pattern_value_create,
         name='test_pattern_value_create'),
    path('test/value_int/update/<int:pk>/', views.TestPatternValueIntUpdate.as_view(),
         name='test_pattern_value_integer_update'),
    path('test/value_int/delete/<int:pk>/', views.TestPatternValueIntDelete.as_view(),
         name='test_pattern_value_integer_delete'),
    path('test/value_int_pair/update/<int:pk>/', views.TestPatternValueIntPairUpdate.as_view(),
         name='test_pattern_value_integer_pair_update'),
    path('test/value_int_pair/delete/<int:pk>/', views.TestPatternValueIntPairDelete.as_view(),
         name='test_pattern_value_integer_pair_delete'),
    path('test/value_text/update/<int:pk>/', views.TestPatternValueTextUpdate.as_view(),
         name='test_pattern_value_text_update'),
    path('test/value_text/delete/<int:pk>/', views.TestPatternValueTextDelete.as_view(),
         name='test_pattern_value_text_delete'),
]
