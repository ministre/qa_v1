...
urlpatterns = [
    ...
    path('test/add_value_integer_pair/', views.test_pattern_add_value_integer_pair,
         name='test_pattern_add_value_integer_pair'),
    path('test/value_integer_pair/update/<int:pk>/', views.TestPatternValueIntegerPairUpdate.as_view(),
         name='test_pattern_value_integer_pair_update'),
    path('test/value_integer_pair/delete/<int:pk>/', views.TestPatternValueIntegerPairDelete.as_view(),
